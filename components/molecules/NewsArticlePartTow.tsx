  ...
  return (
    ...
    border-b-[#8F8F8F]'>
      ...
      <div className="bg-main bg-cover bg-no-repeat text-center text-white ">
        <div className="container mx-auto py-14 lg:px-[103px]">
          ...
          border-2 border-gray-400">
            ...
            <div className='lg:mx-[11.313rem] my-3 bg-black/50
            shadow-[0px_4px_27px_24px_rgba(0,0,0,0.25)]'>
              <p className='px-10 py-10 text-xl '>
                {article.description}</p>
              <p className='px-10 pb-14 text-xl '>
                Be sure to join us on our Forums over at <a href="https://piratesforums.com"
                  target="_blank"
                  rel="noopener noreferrer" >https://piratesforums.com</a> as well
                  to connect with yer fellow Pirates and Swashbucklers here
                  at POR!. </p>
            </div>
