  ...
  return (
    <div className='relative'>
      <div
        ...
        align-center overflow-hidden py-16">
      ...
      <button
        className="carousel-control-prev absolute top-0 bottom-0 flex
         items-center justify-center p-0 text-center border-0 hover:outline-none
          hover:no-underline focus:outline-none focus:no-underline -left-40"
        type="button"
        onClick={shiftLeft}
      >
      ...
      <button
        className="carousel-control-next absolute top-0 bottom-0 flex
         items-center justify-center p-0 text-center border-0 hover:outline-none
          hover:no-underline focus:outline-none focus:no-underline -right-40"
        type="button"
        onClick={shiftRight}
      >
        <span className="
